...
REG_WRITE(SEQ_BASE, SEQ_TABLE_DATA, 1000);       // Repeats
REG_WRITE(SEQ_BASE, SEQ_TABLE_DATA, 32'h1F003F00);
REG_WRITE(SEQ_BASE, SEQ_TABLE_DATA, 100);       // 1us on
REG_WRITE(SEQ_BASE, SEQ_TABLE_DATA, 25);        // 1us off
...
REG_WRITE(DRV_BASE, DRV_PCAP_TIMEOUT, 125*20);
