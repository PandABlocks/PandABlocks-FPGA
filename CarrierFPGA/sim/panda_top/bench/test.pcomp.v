...
REG_WRITE(PCOMP_BASE, PCOMP_START, 900);
REG_WRITE(PCOMP_BASE, PCOMP_STEP, 0);
REG_WRITE(PCOMP_BASE, PCOMP_WIDTH, 10000);
REG_WRITE(PCOMP_BASE, PCOMP_DIR, 0);
REG_WRITE(PCOMP_BASE, PCOMP_PNUM, 2);
REG_WRITE(PCOMP_BASE, PCOMP_USE_TABLE, 0);

REG_WRITE(PCOMP_BASE+32'h100, PCOMP_ENABLE, PCOMP_OUT0);
REG_WRITE(PCOMP_BASE+32'h100, PCOMP_INP, INENC_VAL0);
REG_WRITE(PCOMP_BASE+32'h100, PCOMP_DELTAP, 50);
REG_WRITE(PCOMP_BASE+32'h100, PCOMP_START, 1000);
REG_WRITE(PCOMP_BASE+32'h100, PCOMP_STEP, 1000);
REG_WRITE(PCOMP_BASE+32'h100, PCOMP_WIDTH, 100);
REG_WRITE(PCOMP_BASE+32'h100, PCOMP_DIR, 0);
REG_WRITE(PCOMP_BASE+32'h100, PCOMP_PNUM, 10);
...
REG_WRITE(PCAP_BASE, PCAP_ENABLE, PCOMP_ACTIVE0);
REG_WRITE(PCAP_BASE, PCAP_CAPTURE, PCOMP_OUT1);
