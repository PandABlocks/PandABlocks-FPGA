...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net PS_SRSTB_1 [get_bd_ports FCLK_RESET0_N] [get_bd_ports PS_SRSTB] [get_bd_pins axi/ARESETN] [get_bd_pins axi/M00_ARESETN] [get_bd_pins axi/S00_ARESETN] [get_bd_pins hp1/m_axi_aresetn] [get_bd_pins ps/PS_SRSTB]
