...
REG_WRITE(COUNTER_BASE, COUNTER_TRIG, 38);   // SEQ_OUTA
...
REG_WRITE(SEQ_BASE, SEQ_PRESCALE, 15);           // 1usec
...
REG_WRITE(REG_BASE, REG_PCAP_WRITE, 13);        // counter #1
REG_WRITE(REG_BASE, REG_PCAP_WRITE, 14);        // counter #1
REG_WRITE(REG_BASE, REG_PCAP_WRITE, 15);        // counter #1
REG_WRITE(REG_BASE, REG_PCAP_WRITE, 16);        // counter #1
REG_WRITE(REG_BASE, REG_PCAP_WRITE, 17);        // counter #1
