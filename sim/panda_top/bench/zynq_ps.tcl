...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.PCW_FCLK_CLK0_FREQ {125000000} CONFIG.PCW_S_AXI_HP0_DATA_WIDTH {32} CONFIG.PCW_USE_M_AXI_GP0 {1} CONFIG.PCW_USE_S_AXI_HP0 {1} CONFIG.PCW_USE_S_AXI_HP1 {1}  ] $ps

  # Create interface connections
  connect_bd_intf_net -intf_net S_AXI_HP0_1 [get_bd_intf_ports S_AXI_HP0] [get_bd_intf_pins ps/S_AXI_HP0]
  ...
  connect_bd_net -net FCLK_RESET0_N_1 [get_bd_ports FCLK_RESET0_N] [get_bd_pins axi/ARESETN] [get_bd_pins axi/M00_ARESETN] [get_bd_pins axi/S00_ARESETN] [get_bd_pins hp1/m_axi_aresetn]
  ...
  connect_bd_net -net PS_SRSTB_1 [get_bd_ports PS_SRSTB] [get_bd_pins ps/PS_SRSTB]
  connect_bd_net -net processing_system7_bfm_0_FCLK_CLK0 [get_bd_ports FCLK_CLK0] [get_bd_pins axi/ACLK] [get_bd_pins axi/M00_ACLK] [get_bd_pins axi/S00_ACLK] [get_bd_pins hp1/m_axi_aclk] [get_bd_pins ps/FCLK_CLK0] [get_bd_pins ps/M_AXI_GP0_ACLK] [get_bd_pins ps/S_AXI_HP0_ACLK] [get_bd_pins ps/S_AXI_HP1_ACLK]
