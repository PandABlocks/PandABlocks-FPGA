...
rclone mount --file-perms 0777 --attr-timeout=10m --no-modtime --read-only --daemon --allow-other --unlink --vfs-cache-mode full fpga-vivado:dls-controls-fpga-xilinx /scratch/Xilinx
