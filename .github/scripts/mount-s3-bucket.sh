...
rclone copy fpga-vivado:dls-controls-fpga-xilinx/Vivado/2023.2 /scratch/Xilinx/Vivado/2023.2 --transfers=64 --disable-http2 --checkers=256 --progress
rclone copy fpga-vivado:dls-controls-fpga-xilinx/Vitis/2023.2 /scratch/Xilinx/Vitis/2023.2 --transfers=64 --disable-http2 --checkers=256 --progress
rclone copy fpga-vivado:dls-controls-fpga-xilinx/Vitis_HLS/2023.2 /scratch/Xilinx/Vitis_HLS/2023.2 --transfers=64 --disable-http2 --checkers=256 --progress
