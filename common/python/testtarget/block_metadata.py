        ...
        with open(self.config_dir / 'registers', 'r') as f:
            for line in f:
                ...
                if in_field:
                    ...
                    self.blocks[block_name]['fields'].setdefault(field_name, {})['args'] = \
                    ...
                    self.blocks[block_name]['address'] = block_address
                    self.block_address_to_name[block_address] = block_name

    def parse_config(self):
        block_name = None
        n_line = 1
        for block_name in ['*REG', '*DRV']:
                ...
                if in_field:
                    ...
                    if enum_match:
                        ...
                        self.blocks[block_name]['fields'][field_name] = \
                          { 'type': field_type }
                        if field_type.startswith('table'):
                            self.blocks[block_name]['has_table'] = True
                else:
