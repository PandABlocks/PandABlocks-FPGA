...
set_property FILE_TYPE "VHDL 2019" [get_files $AUTOGEN/hdl/*.vhd]

# Read design files

add_files [glob $TOP_DIR/common/hdl/defines/*.vhd]
set_property FILE_TYPE "VHDL 2019" [get_files $TOP_DIR/common/hdl/defines/*.vhd]
add_files [glob $TOP_DIR/common/hdl/*.vhd]
set_property FILE_TYPE "VHDL 2019" [get_files $TOP_DIR/common/hdl/*.vhd]
add_files [glob $TOP_DIR/common/hdl_$PLATFORM/*.vhd]
set_property FILE_TYPE "VHDL 2019" [get_files $TOP_DIR/common/hdl_$PLATFORM/*.vhd]
add_files [glob $TARGET_DIR/hdl/*]
set_property FILE_TYPE "VHDL 2019" [get_files $TARGET_DIR/hdl/*.vhd]
