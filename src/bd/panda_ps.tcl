...
CONFIG.PCW_FPGA0_PERIPHERAL_FREQMHZ {125} CONFIG.PCW_FPGA1_PERIPHERAL_FREQMHZ {100} \
...
CONFIG.PCW_SD1_PERIPHERAL_ENABLE {1} CONFIG.PCW_SDIO_PERIPHERAL_CLKSRC {IO PLL} \
