...
function fontScale() {  // causes layout problems in FireFox that get fixed if browser's Reload is used; same may be true of other Gecko-based browsers
	...
	var hScale = 39;  // perhaps should auto-calculate based on theme's declared value?
	if (window.innerHeight) {
		...
		var vSize = 1080; //700;  // assuming 1024x768, minus chrome and such
		var hSize = 1920; //1024; // these do not account for kiosk mode or Opera Show
	}
