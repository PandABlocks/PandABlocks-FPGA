...
if { $list_projs eq "" } {
   create_project project_1 myproj -part xczu6cg-ffvc900-1-e
}
...
\
  ...
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_IIC_1 [get_bd_intf_pins zynq_ultra_ps_e_0/IIC_1] [get_bd_intf_ports IIC_1]
